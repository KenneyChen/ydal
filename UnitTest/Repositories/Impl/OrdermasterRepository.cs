...
{
    public class OrdermasterRepository: BaseEfRepository<Ordermaster>,IOrdermasterRepository
    {
        /// <summary>
        ///  获取 仓储上下文的实例
        /// </summary>
        ...
        public OrdermasterRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
